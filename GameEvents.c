...
CARDEVENT E_FamineStrikes = { 5, ADVANCED_EVENT, RESOURCE_TYPE_EVENT,"Famine have struck your kingdom, Distribute Food to advert the crisis. ", E_DECREASE_RESOURCE, 20, R_MORALE_INDEX, R_FOOD_INDEX, 30, "Distribute Food", E_DECREASE_RESOURCE, 10, R_MORALE_INDEX, R_POPULATION_INDEX, 5, "Ignore" };
