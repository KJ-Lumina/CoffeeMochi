...
, {0,0,0,-10}, { {0,0},{0,0} }, "We need to focus on our necessities, entertainment can wait." };
...
, {0,0,0,10}, { {0,0},{0,0} }, "We need to give our citizens a sense of security, proceed with the investigation! We want the culprit aprehended. "
...
, {-10,0,0,10}, { {0,0},{0,0} }, "Divide our manpower to sort out the damages and to repair the damaged houses."
...
,{0,-30,0,20}, { {0,0},{0,0} }, "Get all our manpower ready, we need to start distributing the food supplies to each household to overcome this famine."
, {0,0,0,-10}, { {0,0},{0,0} }, "We must brace through this famine. Focus on helping those crucial citizens, make sure they have food to survive." };
