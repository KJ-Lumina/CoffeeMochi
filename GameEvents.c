...
CARDEVENT E_BuildAHouse = { 1, BASIC_EVENT, BUILD_TYPE_EVENT, "Gorvernor, our population have grown and citizen are requesting for more houses to be build", B_HOUSE_INDEX, 1 , R_POPULATION_INDEX, R_GOLD_INDEX, 5, "House", E_DECREASE_RESOURCE, 2 ,R_MORALE_INDEX, R_NULL_INDEX, 0 ,"There is enough Houses, Ignore your citizen's request" };
CARDEVENT E_BuildAMarket = { 2 , BASIC_EVENT, BUILD_TYPE_EVENT, "Gorvernor, our markets are getting too packed, constructing another market would spread the traffic.", B_MARKET_INDEX, 1 , R_GOLD_INDEX , R_GOLD_INDEX, 7, "Market", E_DECREASE_RESOURCE, 2 , R_MORALE_INDEX, R_NULL_INDEX, 0 , "Refuse the request to build a market." };
CARDEVENT E_ScarceFood = { 3, BASIC_EVENT, BUILD_TYPE_EVENT, "Gorvernor, there is a food shortage in our kingdom. We advice you to build a farm to solve the food shortage.", B_FARM_INDEX, 1, R_FOOD_INDEX, R_GOLD_INDEX, 3, "Build a Farm", E_DECREASE_RESOURCE, 2, R_MORALE_INDEX, R_NULL_INDEX, 0, "Refuse the request to build a farm" };
CARDEVENT E_MerchantSetUp = { 4, BASIC_EVENT, BUILD_TYPE_EVENT, "Gorvernor, with our kingdom reputation growth, various merchant have shown interest in settling down in our kingdom. We advice you to construct 2 markets to create market space for the new merchants", B_MARKET_INDEX, 2, R_GOLD_INDEX, R_GOLD_INDEX , 15, "Invite the merchants in and set up 2 market spot for them.", NULL_CHOICE,0 , R_NULL_INDEX, R_NULL_INDEX, 0, "Reject the Merchants from entering." };
...
CARDEVENT E_FoodMerchantArrival = { 6, BASIC_EVENT, RESOURCE_TYPE_EVENT, "Gorvernor, multiple food peddlers have arrived at your kingdom, they wish to sell us their wares", E_INCREASE_RESOURCE, 20, R_FOOD_INDEX, R_GOLD_INDEX, 10, "Buy Food", NULL_CHOICE, 0 , R_NULL_INDEX, R_NULL_INDEX, 0, "Ignore" };
